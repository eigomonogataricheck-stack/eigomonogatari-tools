...
function execTier(){
  ...
  fetch(OPINION_URL+'?api=tierlog'
    +'&mode='+encodeURIComponent(gt_('mode'))
    +'&attribute='+encodeURIComponent(gt_('attribute'))
    +'&cost='+encodeURIComponent(gt_('cost'))
    +'&waku='+encodeURIComponent(gt_('waku'))
    +'&hosei='+encodeURIComponent(gt_('hosei'))
    +'&minCount='+encodeURIComponent(document.getElementById('minCount').value)
  ).catch(function(){});
